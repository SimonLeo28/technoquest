  ...
  return (
    <section id="prizes" className="bg-black text-white py-20 px-6 md:px-24">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex justify-center items-center"><Image src={dates} className="w-[750px] h-[500px]" alt="dates img" /></div>
        ...
        <p className="mt-12 text-gray-400 text-sm md:text-base">
          Recognition, rewards, and a chance to showcase your talent — <span className="text-[#9B59B6] font-medium">Smart Indian Hackathon Techno-Quest 3.O</span> believes in appreciating every spark of innovation.
        </p>
      </div>
    </section>
  );
